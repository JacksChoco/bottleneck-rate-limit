...
const readLimiter = new Bottleneck({
  maxConcurrent: null,
  minTime: 100,
  id: "productReadStream", // Should be unique for every limiter in the same Redis db
...
const writeLimiter = new Bottleneck({
  maxConcurrent: null,
  minTime: 100,
  id: "productWriteStream", // Should be unique for every limiter in the same Redis db
